...
public class InspectImageResponse extends DockerObject {
    ...
    private com.github.dockerjava.api.command.GraphDriver graphDriver;

    @JsonProperty("RootFS")
    private com.github.dockerjava.api.command.RootFS rootFS;
     ...
     */
    @CheckForNull
    public com.github.dockerjava.api.command.GraphDriver getGraphDriver() {
        return graphDriver;
    }
     ...
     */
    @CheckForNull
    public com.github.dockerjava.api.command.RootFS getRootFS() {
        return rootFS;
    }
