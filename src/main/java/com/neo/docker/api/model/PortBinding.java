...
/**
 * In a {@link PortBinding}, a network socket on the Docker host, expressed as a {@link Binding}, is bound to an {@link com.github.dockerjava.api.model.ExposedPort} of a
...
public class PortBinding extends DockerObject implements Serializable {
    ...
    public PortBinding(Binding binding, com.github.dockerjava.api.model.ExposedPort exposedPort) {
    ...
    public com.github.dockerjava.api.model.ExposedPort getExposedPort() {
        return exposedPort;
    }
