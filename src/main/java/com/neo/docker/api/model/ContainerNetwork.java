...
@EqualsAndHashCode
@ToString
public class ContainerNetwork extends com.github.dockerjava.api.model.DockerObject implements Serializable {
     ...
     * @see #links
     */
    public ContainerNetwork withLinks(List<com.github.dockerjava.api.model.Link> links) {
