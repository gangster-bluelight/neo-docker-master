...
public class HostConfig extends DockerObject implements Serializable {
    ...
    @JsonProperty("Binds")
    private com.github.dockerjava.api.model.Binds binds;
    ...
    @JsonProperty("CapAdd")
    private com.github.dockerjava.api.model.Capability[] capAdd;

    @JsonProperty("CapDrop")
    private com.github.dockerjava.api.model.Capability[] capDrop;
    ...
    private com.github.dockerjava.api.model.Device[] devices;
    ...
    @JsonProperty("Links")
    private com.github.dockerjava.api.model.Links links;

    @JsonProperty("LogConfig")
    private com.github.dockerjava.api.model.LogConfig logConfig;

    @JsonProperty("LxcConf")
    private com.github.dockerjava.api.model.LxcConf[] lxcConf;
    ...
    private com.github.dockerjava.api.model.Ports portBindings;
    ...
    private com.github.dockerjava.api.model.Ulimit[] ulimits;
    ...
    @JsonProperty("Mounts")
    private List<com.github.dockerjava.api.model.Mount> mounts;

    @JsonProperty("PidMode")
    private String pidMode;

    @JsonProperty("Isolation")
    private com.github.dockerjava.api.model.Isolation isolation;
    ...
    public com.github.dockerjava.api.model.Bind[] getBinds() {
        return (binds == null) ? new com.github.dockerjava.api.model.Bind[0] : binds.getBinds();
    }
    ...
    public com.github.dockerjava.api.model.Capability[] getCapAdd() {
        return capAdd;
    }

    public com.github.dockerjava.api.model.Capability[] getCapDrop() {
        return capDrop;
    }
    ...
    public com.github.dockerjava.api.model.Device[] getDevices() {
        return devices;
    }
    ...
    public com.github.dockerjava.api.model.Link[] getLinks() {
        return (links == null) ? new com.github.dockerjava.api.model.Link[0] : links.getLinks();
    }

    @JsonIgnore
    public com.github.dockerjava.api.model.LogConfig getLogConfig() {
        return (logConfig == null) ? new com.github.dockerjava.api.model.LogConfig() : logConfig;
    }

    public com.github.dockerjava.api.model.LxcConf[] getLxcConf() {
        return lxcConf;
    }
    ...
    public com.github.dockerjava.api.model.Ports getPortBindings() {
        return portBindings;
    }
    ...
    public com.github.dockerjava.api.model.Ulimit[] getUlimits() {
        return ulimits;
    }
    ...
    @JsonIgnore
    public void setBinds(com.github.dockerjava.api.model.Bind... binds) {
        this.binds = new com.github.dockerjava.api.model.Binds(binds);
    }

    @JsonIgnore
    public void setLinks(com.github.dockerjava.api.model.Link... links) {
        this.links = new com.github.dockerjava.api.model.Links(links);
    }
    ...
    public HostConfig withBinds(com.github.dockerjava.api.model.Bind... binds) {
        requireNonNull(binds, "binds was not specified");
        setBinds(binds);
        return this;
    }

    public HostConfig withBinds(List<com.github.dockerjava.api.model.Bind> binds) {
        requireNonNull(binds, "binds was not specified");
     ...
     * @see #capAdd
     */
    public HostConfig withCapAdd(com.github.dockerjava.api.model.Capability... capAdd) {
        this.capAdd = capAdd;
        return this;
    }
     ...
     * @see #devices
     */
    public HostConfig withDevices(com.github.dockerjava.api.model.Device... devices) {
        this.devices = devices;
        return this;
    }

    public HostConfig withDevices(List<com.github.dockerjava.api.model.Device> devices) {
    ...
    public HostConfig withLinks(com.github.dockerjava.api.model.Link... links) {
        requireNonNull(links, "links was not specified");
        setLinks(links);
        return this;
    }

    public HostConfig withLinks(List<com.github.dockerjava.api.model.Link> links) {
        requireNonNull(links, "links was not specified");
     ...
     */
    public HostConfig withPortBindings(com.github.dockerjava.api.model.Ports portBindings) {
     ...
     * @see #ulimits
     */
    public HostConfig withUlimits(com.github.dockerjava.api.model.Ulimit[] ulimits) {
        this.ulimits = ulimits;
        return this;
    }

    public HostConfig withUlimits(List<com.github.dockerjava.api.model.Ulimit> ulimits) {
    ...
    @CheckForNull
    public List<com.github.dockerjava.api.model.Mount> getMounts() {
        return mounts;
    }
    ...
    @CheckForNull
    public com.github.dockerjava.api.model.Isolation getIsolation() {
        return isolation;
    }
