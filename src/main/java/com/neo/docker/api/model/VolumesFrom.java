...
public class VolumesFrom implements Serializable {
    ...
    private com.github.dockerjava.api.model.AccessMode accessMode;

    public VolumesFrom(String container) {
        this(container, com.github.dockerjava.api.model.AccessMode.DEFAULT);
    }

    public VolumesFrom(String container, com.github.dockerjava.api.model.AccessMode accessMode) {
    ...
    public com.github.dockerjava.api.model.AccessMode getAccessMode() {
        return accessMode;
    }
